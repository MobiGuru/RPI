...
plugins=(git git-extras colored-man-pages common-aliases command-not-found dirhistory docker extract history zsh-syntax-highlighting zsh-autosuggestions zsh-completions zsh-history-substring-search)
